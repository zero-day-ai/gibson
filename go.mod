...
require (
	...
	github.com/zero-day-ai/sdk v0.20.0
...
// Use the forked tokenizer required by all-minilm-l6-v2-go v0.0.9
// The fork includes API compatibility fixes for the ONNX embedder
